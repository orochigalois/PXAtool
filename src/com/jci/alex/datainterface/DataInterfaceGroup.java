...
/***
 * This class is here only because of the need to draw rectangle for highlight
 * function
 * 
 * @author X
 * 
 */
public class DataInterfaceGroup
{
	...
	public DataInterfaceGroup(TreePath TP, String ID, String X, String Y, String WIDTH,
